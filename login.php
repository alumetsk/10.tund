<?php
    ...
    // *********************
      ...
      // Kui oleme siia jõudnud, võime kasutaja sisse logida
			if($password_error == "" && $email_error == ""){
				...
				$hash = hash("sha512", $password); //krüpteerib parooli, 128 tähemärki pikaks
				...
				if(isset($login_response->success)){
					...
					//saadan sõnumi teise faili kasut. SESSIOONI
  ...
  function cleanInput($data) {
  	...
  	$data = htmlspecialchars($data); //nurksulud jne eemaldab
  	return $data;
  }
